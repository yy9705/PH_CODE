...
//{
// /*
//    currentDataPoint.valuePH = ;//Add Sensor Data Collection
//    currentDataPoint.valueTU = ;//Add Sensor Data Collection
//    currentDataPoint.valueTEMP = ;//Add Sensor Data Collection
//    currentDataPoint.valueTDS = ;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    /*
      currentDataPoint.valuePH = ;
      currentDataPoint.valueTU = ;
      currentDataPoint.valueTEMP = ;
      currentDataPoint.valueTDS = ;
    */
